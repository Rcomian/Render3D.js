...
inquisitiveturtle.render3d.prim.cube = function() {
    ...
    this._faces = [
      new this.__face().setPoints([ this._points[0], this._points[1], this._points[2], this._points[3] ]).setColor( new vector(1, 0, 0) ),     // 0 Left plane
      new this.__face().setPoints([ this._points[0], this._points[7], this._points[6], this._points[1] ]).setColor( new vector(0, 1, 0) ),     // 0 Back plane
      new this.__face().setPoints([ this._points[0], this._points[3], this._points[4], this._points[7] ]).setColor( new vector(0, 0, 1) ),     // 0 Top plane
      new this.__face().setPoints([ this._points[5], this._points[4], this._points[3], this._points[2] ]).setColor( new vector(1, 1, 0) ),     // 0 Front plane
      new this.__face().setPoints([ this._points[5], this._points[6], this._points[7], this._points[4] ]).setColor( new vector(0, 1, 1) ),     // 0 Right plane
      new this.__face().setPoints([ this._points[5], this._points[2], this._points[1], this._points[6] ]).setColor( new vector(1, 0, 1) )      // 0 Bottom plane
    ];
  }
